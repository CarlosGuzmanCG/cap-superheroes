		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "superheroes",
									"targetURL": "#comguzcapsuperheroesui5superheroe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comguzcapsuperheroesui5superheroe-display": {
								"semanticObject": "comguzcapsuperheroesui5superheroe",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.guz.cap.superheroes.ui5superheroe",
									"url": sap.ui.require.toUrl("com/guz/cap/superheroes/ui5superheroe")
								}
							}
						}
					}
